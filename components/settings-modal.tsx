...
export function SettingsModal() {
  ...
  async function handleDeleteAccount(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      if (isDesignPreview)
        throw new Error("Account changes are disabled in this local preview.");
      ...
      <section className="settings-panel">
        <div className="flex flex-wrap items-start justify-between gap-4 border-b border-[var(--border-soft)] pb-4">
          <div>
            ...
            <h2
              id="settings-heading"
              className="mt-2 text-2xl font-semibold tracking-tight text-[var(--ink)]"
            >
              Manage your account.
            </h2>
          </div>
        ...
        <div className="settings-session-row">
          <span>Your profile, schedule, and account.</span>
        ...
        <div className="mt-5 grid gap-5 xl:grid-cols-2">
          ...
          <form
            ...
            className="rounded-[1.6rem] border border-[var(--border-soft)] bg-[var(--surface)] p-4"
          >
            <p className="text-sm font-semibold text-[var(--ink)]">
              Change password
            </p>
            <p className="mt-2 text-sm leading-7 text-[var(--muted)]">
              Choose a strong password — at least 6 characters, with one number
              or symbol.
            </p>
            <label className="mt-4 block">
              <span className="mb-2 block text-sm font-medium text-[var(--ink)]">
        ...
        <div className="mt-5 rounded-[1.7rem] border border-[var(--border-soft)] bg-[var(--surface)] p-5">
          ...
          <div className="mt-5 grid gap-5 xl:grid-cols-2">
            <div className="rounded-[1.5rem] border border-[var(--border-soft)] bg-white p-4">
              ...
              <p className="mt-2 text-sm leading-7 text-[var(--muted)]">
                Pause your brief emails if you need a break. Your settings and
                history are kept.
              </p>
            ...
            <div className="rounded-[1.5rem] border border-[var(--border-soft)] bg-white p-4">
              ...
              <p className="mt-2 text-sm leading-7 text-[var(--muted)]">
                Choose whether HunterAgent writes your CV and cover letter, or
                you manage your own materials and use the dashboard for
                tracking.
              </p>
              <div className="mt-4 flex flex-wrap gap-3">
                <button
                  ...
                  <label className="grid gap-2 text-sm">
                    ...
                    <textarea
                      ...
                      onChange={(event) =>
                        setDraftProfile((current) => ({
                          ...current,
                          specialPreferences: parsePreferenceList(
                            event.target.value,
                          ),
                        }))
                      }
          ...
          {!showDeleteConfirm ? (
            <div className="mt-4">
              <p className="text-sm leading-6 text-[var(--muted)]">
                Permanently delete your account and all application data. This
                cannot be undone.
              </p>
              <button
                type="button"
            ...
            >
              <p className="text-sm leading-6 text-[var(--muted)]">
                Enter your password to confirm. This will permanently erase your
              ...
              <input
                ...
                aria-label="Confirm account deletion with your password"
                required
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="rounded-full border border-[var(--border-soft)] bg-white px-4 py-2 text-sm font-medium text-[var(--muted)]"
                >
                  Cancel
                </button>
              </div>
